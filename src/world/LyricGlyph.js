...
export const GLYPH_SHAPES = {
  heart: [
    { x: 0.50, y: 0.95 }, { x: 0.18, y: 0.52 }, { x: 0.08, y: 0.22 },
    { x: 0.28, y: 0.05 }, { x: 0.50, y: 0.25 }, { x: 0.72, y: 0.05 },
    { x: 0.92, y: 0.22 }, { x: 0.82, y: 0.52 },
  ],
  star: [
  ...
  flame: [
    { x: 0.50, y: 0.00 }, { x: 0.35, y: 0.25 }, { x: 0.42, y: 0.48 },
    { x: 0.20, y: 0.65 }, { x: 0.30, y: 0.95 },
    { x: 0.70, y: 0.95 }, { x: 0.80, y: 0.65 },
    { x: 0.58, y: 0.48 },
  ],
  moon: [
    { x: 0.75, y: 0.10 }, { x: 0.50, y: 0.02 }, { x: 0.25, y: 0.15 },
    { x: 0.12, y: 0.40 }, { x: 0.12, y: 0.65 },
    { x: 0.25, y: 0.88 }, { x: 0.50, y: 0.98 }, { x: 0.75, y: 0.90 },
  ],
  diamond: [
  ...
  skull: [
    { x: 0.50, y: 0.02 }, { x: 0.85, y: 0.18 }, { x: 0.92, y: 0.48 },
    { x: 0.78, y: 0.72 }, { x: 0.58, y: 0.70 },
    { x: 0.42, y: 0.70 }, { x: 0.22, y: 0.72 },
    { x: 0.08, y: 0.48 },
  ],
  eye: [
  ...
  // Easter eggs
  leaf: [
    { x: 0.50, y: 0.00 }, { x: 0.35, y: 0.22 }, { x: 0.08, y: 0.20 },
    { x: 0.20, y: 0.50 }, { x: 0.10, y: 0.75 },
    { x: 0.50, y: 0.60 }, { x: 0.90, y: 0.75 }, { x: 0.80, y: 0.50 },
  ],
  rocket: [
