...
export const PERSONALITY = {
  ...
  EMBER: { rdBias: 0.25, ribbonScale: 1.15, swarmBand: [0.30, 0.60] },
  ARCTIC: { swarmBand: [0.04, 0.22], mandalaRate: 0.65, cymaticModes: [3, 5, 7] }, // motes ride at aurora height, figures stay hexagonal-fine
  JADE: { swarmBand: [0.25, 0.60], mandalaRate: 0.8 },
  VOID: { ribbonScale: 1.5, cymaticModes: [4, 6, 7], mandalaRate: 1.15 }, // chaos temple: the attractor looms
  SAKURA: { swarmBand: [0.20, 0.55], mandalaRate: 0.75, rdBias: -0.1 },
  SOLAR: { rdBias: 0.15, ribbonScale: 1.1, mandalaRate: 1.2 },
  CYBER: { cymaticModes: [1, 4, 6], ribbonScale: 1.2, swarmBand: [0.35, 0.60], mandalaRate: 1.1 },
  STORM: { ribbonScale: 1.3, rdBias: 0.2, swarmBand: [0.10, 0.35], mandalaRate: 1.05 },
};
